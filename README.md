...
In this repo we cover all the critical functionalities that blockchain offers to mantain a transparent transaction between participants when trading products in a supply chain:
...
* Agriculture Sourced Products tracking
* Interactions between participans in trade opperations.
...
* New Products will be created by the Manufacturer/Seller only.
* Then Product will be sent to WholeSeller/Buyer
* Wholesalers/Buyer or Manufacturer/Seller will send the product to the Distributor/Forwarder.
* Distributor/Forwarder will send it to Transporter 
* Consumer/End User/Wholesaler/Buyer could place the order 
* Consumer/End User will mark as Delivered once the product is delivered
